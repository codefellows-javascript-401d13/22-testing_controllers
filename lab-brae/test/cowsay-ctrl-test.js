...
describe('Cowsay Controller', function() {
  ...
  describe('initial properties', () => {
    it('title property should equal cow creator. make it, view it, and undo it!', () => {
      expect(this.cowsayCtrl.title).toBe('cow creator. make it, view it, and undo it!');
    });
    ...
    it('lise of cowfiles should show proper cowfiles', () => {
